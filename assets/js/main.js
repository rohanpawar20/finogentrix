  ...
  var rtsJs = {
    ...
    preloader: function () {
      function markLoaded() {
        ...
        if (bodyEl && !bodyEl.classList.contains('loaded')) {
          bodyEl.classList.add('loaded');
        }
      }

      // If the page is already loaded (scripts injected dynamically), mark immediately
      if (document.readyState === 'complete') {
        markLoaded();
      } else {
        // Fallbacks for normal flow
        window.addEventListener('load', markLoaded);
        document.addEventListener('DOMContentLoaded', function () {
          // In case load fires before this script was attached
